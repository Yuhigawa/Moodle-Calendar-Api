...
let deliveryDate = require("../assets/deliveryDate.json");
...
const TOKEN_PATH = "./src/assets/token.json";
const CREDENTIAL_PATH = "./src/assets/credentials.json";

function startGoogleCalendarApi() {
